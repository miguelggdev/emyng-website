...
const timelineEvents = [
  ...
  },
  {
    ...
    events: [
      ...
      "5° lugar - Tres Pistas, Francia",
      "3° lugar Larga distancia - Lagos, Portugal 🥉",
    ],
    icon: <Trophy className="text-yellow-400" />,
  },
  {
    ...
    events: [
      ...
      "3° lugar - Trofeo Lagos, Portugal 🥉",
      "9° lugar - Tres Pistas, Francia",
    ],
  ...
  },
  {
    ...
    events: [
      ...
      "4° lugar - Tres Pistas, Francia (Debut Europeo)",
    ],
